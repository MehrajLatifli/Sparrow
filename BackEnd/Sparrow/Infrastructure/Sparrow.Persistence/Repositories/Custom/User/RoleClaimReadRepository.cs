...
{
    public class RoleClaimReadRepository : UserReadRepository<RoleClaim>, IRoleClaimReadRepository
    {
        public RoleClaimReadRepository(User_DbContext context) : base(context)
        {
        }
    }
}
