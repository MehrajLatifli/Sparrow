...
{
    public class UserClaimReadRepository : UserReadRepository<UserClaim>, IUserClaimReadRepository
    {
        public UserClaimReadRepository(User_DbContext context) : base(context)
        {
        }
    }
}
