...
{
    public class UserClaimWriteRepository : UserWriteRepository<UserClaim>, IUserClaimWriteRepository
    {
        public UserClaimWriteRepository(User_DbContext context) : base(context)
        {
