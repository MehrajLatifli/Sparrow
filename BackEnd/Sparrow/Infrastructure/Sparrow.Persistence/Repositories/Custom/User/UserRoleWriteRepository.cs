...
{
    public class UserRoleWriteRepository : UserWriteRepository<UserRole>, IUserRoleWriteRepository
    {
        public UserRoleWriteRepository(User_DbContext context) : base(context)
        {
