...
{
    public class PlaylistWriteRepository : MusicWriteRepository<Playlist>, IPlaylistWriteRepository
    {
        public PlaylistWriteRepository(Music_DbContext context) : base(context)
        {
