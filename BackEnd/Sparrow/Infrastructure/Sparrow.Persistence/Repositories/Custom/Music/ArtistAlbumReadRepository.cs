...
{
    public class ArtistAlbumReadRepository : MusicReadRepository<ArtistAlbum>, IArtistAlbumReadRepository
    {
        public ArtistAlbumReadRepository(Music_DbContext context) : base(context)
        {
        }
    }
