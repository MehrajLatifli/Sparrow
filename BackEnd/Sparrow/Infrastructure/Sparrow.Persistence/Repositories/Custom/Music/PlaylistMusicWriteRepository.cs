...
{
    public class PlaylistMusicWriteRepository : MusicWriteRepository<PlaylistMusic>, IPlaylistMusicWriteRepository
    {
        public PlaylistMusicWriteRepository(Music_DbContext context) : base(context)
        {
